...
public class SubSpaceServiceImpl implements SubSpaceService {
    ...
    @Override
    public SubSpace findById(int id) {
...
//    }
    @Override
    public SubSpace findByName(String SubSpaceName) {
        return subSpaceRepo.findByName(SubSpaceName);
    }

    @Override
    public SubSpace findSubSpaceBySpaceNameAndSubspaceName(String spaceName, String subspaceName) {
        return subSpaceRepo.findSubSpaceBySpaceNameAndSubspaceName(spaceName, subspaceName);
    }
